...
The `symlinks-config.sh` file stores the path to your personal code directory. This is **auto-generated** on the first run of `install-scripts.sh` — you will be prompted to enter the directory path. To change it, edit or delete the file & re-run `install-scripts.sh`.
