...
- `install-scripts.sh`: Script to create symlinks in `~/.local/bin` for scripts you want accessible from anywhere. Idempotent & safe to run multiple times. Also cleans up dangling symlinks.
